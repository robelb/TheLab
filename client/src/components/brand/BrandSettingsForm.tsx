    ...
    <div className="space-y-6">
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="https://..."
              value={brand.logo ?? ''}
              onChange={(e) => setBrand({ logo: e.target.value || null })}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              id="favicon"
              value={brand.favicon ?? ''}
              onChange={(e) => setBrand({ favicon: e.target.value || null })}
            />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Primary, secondary, and supporting palette
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 sm:grid-cols-2">
          <ColorField
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Radius, spacing, theme, and component style
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(e) => patchCustomization('buttonStyle', e.target.value)}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Paste full brand JSON to replace all settings
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <textarea
